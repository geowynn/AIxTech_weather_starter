  ...
  return (
    ...
    >
      <button
        ...
        onClick={onDelete}
        className="absolute right-2 top-2 z-10 rounded-full border border-white/10 bg-black/25 p-1.5 text-white/60 transition hover:border-white/20 hover:bg-black/45 hover:text-white"
      >
